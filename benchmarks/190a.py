...
class POEditorAPI(object):
    ...
    def _run(self, action, headers=None, **kwargs):
        ...
        if payload.get("file"):
            ...
            response = requests.post(
                url=self.HOST, data=payload, headers=headers, files=file
            )
        else:
    ...
    def list_projects(self):
        ...
        """
        data = self._run(action="list_projects")
    ...
    def create_project(self, name, description=None):
        ...
        data = self._run(action="create_project", name=name, description=description)
    ...
    def view_project_details(self, project_id):
        ...
        """
        data = self._run(action="view_project", id=project_id)
    ...
    def list_project_languages(self, project_id):
        ...
        """
        data = self._run(action="list_languages", id=project_id)
    ...
    def add_language_to_project(self, project_id, language_code):
        ...
        """
        self._run(action="add_language", id=project_id, language=language_code)
        return True
    ...
    def delete_language_from_project(self, project_id, language_code):
        ...
        """
        self._run(action="delete_language", id=project_id, language=language_code)
        return True
    ...
    def set_reference_language(self, project_id, language_code):
        ...
        """
        self._run(
            action="set_reference_language", id=project_id, language=language_code
        )
        return True
    ...
    def clear_reference_language(self, project_id):
        ...
        """
        self._run(action="clear_reference_language", id=project_id)
        return True
    ...
    def view_project_terms(self, project_id, language_code=None):
        ...
        Clears reference language from project
        """
        data = self._run(action="view_terms", id=project_id, language=language_code)
        return data.get("list", [])
    ...
    def add_terms(self, project_id, data):
        ...
        """
        data = self._run(action="add_terms", id=project_id, data=json.dumps(data))
        return data["details"]
    ...
    def delete_terms(self, project_id, data):
        ...
        """
        data = self._run(action="delete_terms", id=project_id, data=json.dumps(data))
        return data["details"]
    ...
    def sync_terms(self, project_id, data):
        ...
        """
        data = self._run(action="sync_terms", id=project_id, data=json.dumps(data))
        return data["details"]
    ...
    def _upload(
        ...
        options = [self.UPDATING_TERMS_DEFINITIONS, self.UPDATING_DEFINITIONS]
        if language_code is None and updating in options:
            raise POEditorArgsException(
                "Language code is required only if updating is "
                "terms_definitions or definitions)"
            )
    ...
    def available_languages(self):
        ...
        """
        data = self._run(action="available_languages")
        return data.get("list", {})
    ...
    def list_contributors(self, project_id=None, language_code=None):
        ...
        """
        data = self._run(
            action="list_contributors", id=project_id, language=language_code
        )
        return data.get("list", [])
    ...
    def add_administrator(self, project_id, name, email):
        ...
        """
        self._run(
            action="add_contributor", id=project_id, name=name, email=email, admin=True
        )
        return True
