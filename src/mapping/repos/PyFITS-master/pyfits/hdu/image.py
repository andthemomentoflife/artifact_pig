...
class _ImageBaseHDU(_ValidHDU):
    ...
    def data(self, data):
        ...
        if data is not None and not isinstance(data, np.ndarray):
            ...
            try:
                ...
                raise TypeError(
                    "data object %r could not be coerced into an " "ndarray" % data
                )
    ...
    def _scale_internal(self, type=None, option="old", bscale=1, bzero=0, blank=0):
        """
    ...
    def _calculate_datasum(self, blocking):
        ...
        if self._has_data:
            ...
            cs = self._compute_checksum(d.flatten().view(np.uint8), blocking=blocking)
