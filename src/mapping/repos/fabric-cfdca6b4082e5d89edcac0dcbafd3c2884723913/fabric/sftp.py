...
class SFTP(object):
    ...
    def get_dir(self, remote_path, local_path):
        ...
        for context, dirs, files in self.walk(remote_path):
            ...
            for f in files:
                ...
                if "%(path)s" not in local_path and "%(dirname)s" not in local_path:
    ...
    def put(
        self, local_path, remote_path, use_sudo, mirror_local_mode, mode, local_is_path
    ):
        from fabric.api import sudo, hide
    ...
    def put_dir(self, local_path, remote_path, use_sudo, mirror_local_mode, mode):
        ...
        for context, dirs, files in os.walk(local_path):
            ...
            for f in files:
                ...
                p = self.put(local_path, n, use_sudo, mirror_local_mode, mode, True)
