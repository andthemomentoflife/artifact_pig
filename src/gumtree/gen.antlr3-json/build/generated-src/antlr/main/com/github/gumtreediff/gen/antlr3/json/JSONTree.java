// $ANTLR 3.5.3 com/github/gumtreediff/gen/antlr3/json/JSONTree.g 2025-04-14 15:35:24
...
public class JSONTree extends TreeParser {
	...
	@Override public String[] getTokenNames() { return JSONTree.tokenNames; }
	@Override public String getGrammarFileName() { return "com/github/gumtreediff/gen/antlr3/json/JSONTree.g"; }
	...
	// $ANTLR start "value"
	// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:126:1: value returns [Object result] : (s= string |n= number |o= object |a= array | TRUE | FALSE | NULL );
	public final Object value() throws RecognitionException {
		...
		try {
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:127:2: (s= string |n= number |o= object |a= array | TRUE | FALSE | NULL )
			int alt1=7;
			switch ( input.LA(1) ) {
			case STRING:
				{
			...
			switch (alt1) {
				case 1 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:127:4: s= string
					{
					...
					break;
				case 2 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:128:4: n= number
					{
					...
					break;
				case 3 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:129:4: o= object
					{
					...
					break;
				case 4 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:130:4: a= array
					{
					...
					break;
				case 5 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:131:4: TRUE
					{
					...
					break;
				case 6 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:132:4: FALSE
					{
					...
					break;
				case 7 :
					// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:133:4: NULL
					{
	...
	// $ANTLR start "string"
	// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:136:1: string returns [String result] : ^( STRING String ) ;
	public final String string() throws RecognitionException {
		...
		try {
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:137:2: ( ^( STRING String ) )
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:137:4: ^( STRING String )
			{
	...
	// $ANTLR start "object"
	// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:141:1: object returns [Map result] : ^( OBJECT ( pair[$result] )+ ) ;
	public final Map object() throws RecognitionException {
		Map result = null;
		 ...
		 result = new HashMap(); 
		try {
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:143:2: ( ^( OBJECT ( pair[$result] )+ ) )
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:143:4: ^( OBJECT ( pair[$result] )+ )
			{
			match(input,OBJECT,FOLLOW_OBJECT_in_object147); 
			match(input, Token.DOWN, null); 
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:143:13: ( pair[$result] )+
			int cnt2=0;
			loop2:
			while (true) {
				int alt2=2;
	...
	// $ANTLR start "number"
	// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:146:1: number returns [Object result] : ^( NUMBER Number ( Exponent )? ) ;
	public final Object number() throws RecognitionException {
		...
		try {
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:147:2: ( ^( NUMBER Number ( Exponent )? ) )
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:147:4: ^( NUMBER Number ( Exponent )? )
			{
			match(input,NUMBER,FOLLOW_NUMBER_in_number169); 
			match(input, Token.DOWN, null); 
			Number2=(CommonTree)match(input,Number,FOLLOW_Number_in_number171); 
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:147:20: ( Exponent )?
			int alt3=2;
	...
	// $ANTLR start "array"
	// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:151:1: array returns [List list] : ^( ARRAY (v= value )* ) ;
	public final List array() throws RecognitionException {
		...
		Object v =null;
		 ...
		 list = new ArrayList(); 
		try {
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:153:2: ( ^( ARRAY (v= value )* ) )
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:153:4: ^( ARRAY (v= value )* )
			{
			match(input,ARRAY,FOLLOW_ARRAY_in_array200); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:153:12: (v= value )*
				loop4:
				while (true) {
					int alt4=2;
					int LA4_0 = input.LA(1);
					if ( (LA4_0==ARRAY||LA4_0==FALSE||(LA4_0 >= NULL && LA4_0 <= NUMBER)||(LA4_0 >= OBJECT && LA4_0 <= STRING)||LA4_0==TRUE) ) {
						alt4=1;
					}

					switch (alt4) {
					case 1 :
						// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:153:13: v= value
						{
	...
	// $ANTLR start "pair"
	// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:156:1: pair[Map map] : ^( FIELD key= String v= value ) ;
	public final void pair(Map map) throws RecognitionException {
		CommonTree key=null;
		Object v =null;

		try {
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:157:2: ( ^( FIELD key= String v= value ) )
			// com/github/gumtreediff/gen/antlr3/json/JSONTree.g:157:4: ^( FIELD key= String v= value )
			{
	...
	public static final BitSet FOLLOW_pair_in_object149 = new BitSet(new long[]{0x0000000000000408L});
	public static final BitSet FOLLOW_NUMBER_in_number169 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_Number_in_number171 = new BitSet(new long[]{0x0000000000000108L});
	...
	public static final BitSet FOLLOW_value_in_array205 = new BitSet(new long[]{0x000000000005B218L});
	public static final BitSet FOLLOW_FIELD_in_pair226 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_String_in_pair230 = new BitSet(new long[]{0x000000000005B210L});
