...
public class XMLLexer extends Lexer {
	...
	public final void mTAG_START_OPEN() throws RecognitionException {
		try {
			...
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:48:16: ( '<' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:48:18: '<'
			{
			match('<'); 
			 tagMode = true; 
			}
	...
	public final void mTAG_END_OPEN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:49:14: ( '</' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:49:16: '</'
			{
			match("</"); 
	...
	public final void mTAG_CLOSE() throws RecognitionException {
		try {
			int _type = TAG_CLOSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:50:11: ({...}? => '>' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:50:13: {...}? => '>'
			{
			if ( !(( tagMode )) ) {
	...
	public final void mTAG_EMPTY_CLOSE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:51:17: ({...}? => '/>' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:51:19: {...}? => '/>'
			{
			if ( !(( tagMode )) ) {
	...
	public final void mATTR_EQ() throws RecognitionException {
		try {
			int _type = ATTR_EQ;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:53:9: ({...}? => '=' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:53:11: {...}? => '='
			{
			if ( !(( tagMode )) ) {
	...
	public final void mATTR_VALUE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:55:12: ({...}? => ( '\"' (~ '\"' )* '\"' | '\\'' (~ '\\'' )* '\\'' ) )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:55:14: {...}? => ( '\"' (~ '\"' )* '\"' | '\\'' (~ '\\'' )* '\\'' )
			{
			if ( !(( tagMode )) ) {
				throw new FailedPredicateException(input, "ATTR_VALUE", " tagMode ");
			}
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:56:9: ( '\"' (~ '\"' )* '\"' | '\\'' (~ '\\'' )* '\\'' )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// com/github/gumtreediff/gen/antlr3/xml/XML.g:56:11: '\"' (~ '\"' )* '\"'
					{
					match('\"'); 
					// com/github/gumtreediff/gen/antlr3/xml/XML.g:56:15: (~ '\"' )*
					loop1:
					while (true) {
						int alt1=2;
						...
						switch (alt1) {
						case 1 :
							// com/github/gumtreediff/gen/antlr3/xml/XML.g:
							{
					...
					break;
				case 2 :
					// com/github/gumtreediff/gen/antlr3/xml/XML.g:57:11: '\\'' (~ '\\'' )* '\\''
					{
					match('\''); 
					// com/github/gumtreediff/gen/antlr3/xml/XML.g:57:16: (~ '\\'' )*
					loop2:
					while (true) {
						int alt2=2;
	...
	public final void mPCDATA() throws RecognitionException {
		try {
			int _type = PCDATA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:61:8: ({...}? => (~ '<' )+ )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:61:10: {...}? => (~ '<' )+
			{
			if ( !(( !tagMode )) ) {
				throw new FailedPredicateException(input, "PCDATA", " !tagMode ");
			}
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:61:26: (~ '<' )+
			int cnt4=0;
			loop4:
			while (true) {
				int alt4=2;
	...
	public final void mGENERIC_ID() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:64:5: ({...}? => ( LETTER | '_' | ':' ) ( NAMECHAR )* )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:64:7: {...}? => ( LETTER | '_' | ':' ) ( NAMECHAR )*
			{
			if ( !(( tagMode )) ) {
			...
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:65:29: ( NAMECHAR )*
			loop5:
			while (true) {
				int alt5=2;
	...
	public final void mNAMECHAR() throws RecognitionException {
		try {
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:69:5: ( LETTER | DIGIT | '.' | '-' | '_' | ':' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:
			{
			if ( (input.LA(1) >= '-' && input.LA(1) <= '.')||(input.LA(1) >= '0' && input.LA(1) <= ':')||(input.LA(1) >= 'A' && input.LA(1) <= 'Z')||input.LA(1)=='_'||(input.LA(1) >= 'a' && input.LA(1) <= 'z') ) {
				input.consume();
	...
	public final void mDIGIT() throws RecognitionException {
		try {
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:73:5: ( '0' .. '9' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:
			{
	...
	public final void mLETTER() throws RecognitionException {
		try {
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:77:5: ( 'a' .. 'z' | 'A' .. 'Z' )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:
			{
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:81:5: ({...}? => ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
			// com/github/gumtreediff/gen/antlr3/xml/XML.g:81:8: {...}? => ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
			{
			if ( !(( tagMode )) ) {
	...
	public void mTokens() throws RecognitionException {
		// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:8: ( TAG_START_OPEN | TAG_END_OPEN | TAG_CLOSE | TAG_EMPTY_CLOSE | ATTR_EQ | ATTR_VALUE | PCDATA | GENERIC_ID | WS )
		int alt6=9;
		alt6 = dfa6.predict(input);
		switch (alt6) {
			case 1 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:10: TAG_START_OPEN
				{
				mTAG_START_OPEN(); 
				...
				break;
			case 2 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:25: TAG_END_OPEN
				{
				mTAG_END_OPEN(); 
				...
				break;
			case 3 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:38: TAG_CLOSE
				{
				mTAG_CLOSE(); 
				...
				break;
			case 4 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:48: TAG_EMPTY_CLOSE
				{
				mTAG_EMPTY_CLOSE(); 
				...
				break;
			case 5 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:64: ATTR_EQ
				{
				mATTR_EQ(); 
				...
				break;
			case 6 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:72: ATTR_VALUE
				{
				mATTR_VALUE(); 
				...
				break;
			case 7 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:83: PCDATA
				{
				mPCDATA(); 
				...
				break;
			case 8 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:90: GENERIC_ID
				{
				mGENERIC_ID(); 
				...
				break;
			case 9 :
				// com/github/gumtreediff/gen/antlr3/xml/XML.g:1:101: WS
				{
				mWS(); 
	...
	static final String DFA6_eotS =
		"\1\uffff\1\13\1\14\1\11\1\16\2\11\1\24\1\26\4\uffff\1\30\1\uffff\1\11"+
		"\1\32\1\uffff\1\11\1\32\1\uffff\1\24\10\uffff";
	static final String DFA6_eofS =
		"\36\uffff";
	static final String DFA6_minS =
		"\1\0\1\57\1\0\1\76\5\0\3\uffff\5\0\1\uffff\5\0\1\uffff\1\0\1\uffff\1\0"+
		"\3\uffff";
	static final String DFA6_maxS =
		"\1\uffff\1\57\1\uffff\1\76\5\uffff\3\uffff\1\0\1\uffff\1\0\2\uffff\1\uffff"+
		"\2\uffff\1\0\1\uffff\1\0\1\uffff\1\0\1\uffff\1\0\3\uffff";
	static final String DFA6_acceptS =
		"\11\uffff\1\7\1\2\1\1\5\uffff\1\6\5\uffff\1\3\1\uffff\1\5\1\uffff\1\10"+
		"\1\11\1\4";
	static final String DFA6_specialS =
		"\1\14\1\uffff\1\4\1\21\1\22\1\15\1\12\1\10\1\13\3\uffff\1\1\1\16\1\3\1"+
		"\11\1\17\1\uffff\1\0\1\20\1\6\1\23\1\7\1\uffff\1\2\1\uffff\1\5\3\uffff}>";
	static final String[] DFA6_transitionS = {
			"\11\11\2\10\1\11\2\10\22\11\1\10\1\11\1\5\4\11\1\6\7\11\1\3\12\11\1\7"+
			"\1\11\1\1\1\4\1\2\2\11\32\7\4\11\1\7\1\11\32\7\uff85\11",
			"\1\12",
			"\74\11\1\uffff\uffc3\11",
			"\1\15",
			"\74\11\1\uffff\uffc3\11",
			...
			"\55\11\2\25\1\11\13\25\1\11\1\uffff\4\11\32\25\4\11\1\25\1\11\32\25"+
			"\uff85\11",
			"\74\11\1\uffff\uffc3\11",
			"",
			"",
